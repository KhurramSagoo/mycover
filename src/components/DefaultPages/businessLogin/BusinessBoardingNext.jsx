        ...
        <div className=" mt-4 px-6 pb-12 pt-6">
            ...
            <div className=" flex
             items-center justify-between md:w-[53%] w-full ">
                ...
                <div className='bg-[#e6f4f2] flex items-center justify-center w-28 rounded-xl px-2 py-2   cursor-pointer transition-opacity duration-500 ease-in-out opacity-80 hover:opacity-100' onClick={() => navigate(-1)}>
                    <ArrowLeft /> <button className='text-xs text-black  font-medium'>Go Back</button>
                </div>
            ...
            <div className=" pt-4 flex items-center flex-col justify-center w-full px-5 md:px-0">
                ...
                <p className="text-2xl font-bold text-[#439687] mb-2  ">Welcome to MyCoverGenius</p>
                <p className="text-gray-800 text-sm font-medium  mb-4">ZenCare covers you and your staff with quality healthcare at only
            ...
            <div className="  flex items-center justify-center mt-6 ">
                <div className="border rounded-lg bg-[#f6fef9] py-6 px-12  max-w-[551px] w-full ">
                    ...
                    <div className=" flex items-start justify-start flex-col">
                        ...
                        <span className=" cursor-pointer text-sm font-semibold text-[#439687] py-5 ml-5"> See more benefits</span>

                    </div>
                    <div className=" text-xs font-semibold text-gray-600 border border-[#f79009] bg-[#fffaeb] p-3 rounded-md">
                        Important Notice: This plan is exclusively available for individuals below the age of 80
                    </div>
            ...
            <div className=" flex items-center justify-center mt-12 w-full">
                <button className=" w-full py-3 px-4 bg-[#439687] text-sm font-bold text-white rounded-lg max-w-[565px] h-[46px]" onClick={handleGetCovered}>
