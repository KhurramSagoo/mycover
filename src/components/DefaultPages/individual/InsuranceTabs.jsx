...
const InsuranceTabs = () => {
            ...
            cardData: [
                {
                    ...
                    price: "₦2,000",
                    tagLine: "This plan provides you with instant access to high-quality healthcare.",
                    detail: [
                        {
                ...
                },
                {
                    ...
                    title: "Flexicare Mini 1",
                    price: "₦3,500",
                    tagLine: "Need an affordable plan that meets all of your health-care needs? This is made for you.",
                    detail: [
                        {
                            one: "Annual medical coverage of up to ₦1,000,000"
                        }, {
            ...
            cardData: [
                {
                    ...
                    price: "5%",
                    tagLine: "Protect yourself and your vehicles from all kinds of damages at only 5% of vehicle value.",
                    detail: [
                        {
                            one: "Annual medical coverage of up to ₦1,000,000"
                        }, {
                ...
                },
                {
                    ...
                    price: "5%",
                    tagLine: "Minimise vehicle risks with our flexible auto insurance coverage at 0.5% of the vehicle value.",
                    detail: [
                        {
                            one: "Annual medical coverage of up to ₦1,000,000"
                        }, {
            ...
            cardData: [
                {
                    ...
                    price: "5%",
                    tagLine: "Our travel Insurance plan gives you 360° degrees coverage when you travel outside the country. A few things you don't have to worry about anymore.",
                    detail: [
                        {
                            one: "Annual medical coverage of up to ₦1,000,000"
                        }, {
    ...
    return (
        <div className='w-full p-5 min-h-screen my-5'>
            ...
            <div className='mt-5'>
                {tabData.map((tab, index) => (
                    <div key={index} className={`flex items-center lg:justify-around justify-center flex-col md:flex-row  ${activeTab === index ? '' : 'hidden'}`}>
                        {tab.cardData.map((card, cardIndex) => (
                            ...
                            >
                                ...
                                <div className=' mt-12'>
                                    ...
                                    <button className='text-secondary px-8 py-2 mt-3 w-[180px]
                                hover:text-white
                                hover:bg-primary border rounded-full
                                '>{card.buttonText.text}</button>
                                </div>
                                {/* learn more */}
                                <div className=' my-4'>

                                    {
                                        card.more.map((more, index) => (
                                            <div key={index}>
                                                <a href="" className=' font-medium hover:text-primary my-2'>{more.text}</a>
