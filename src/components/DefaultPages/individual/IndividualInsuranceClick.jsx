    ...
    const textData = [
        {
            ...
            detail: "Go ahead, make a choice. We’ve got you! You are provided with an array of insurance policies to choose from. Tastefully fitted to your pocket size, assets and family needs.",
            bg: "#ffead5",
            image: iphone,
            active: breifcase,
        ...
        },
        {
            ...
            detail: "It’s time to cross the tees and dot the I on your Insurance. Fill in your personal and Plan details and hop on to step number 3.",
            bg: "#fce7f5",
            image: iphone2,
            active: doc,
        ...
        },
        {
            ...
            detail: "Yes! That’s about it. Now sit back, relax and experience 24/7 seamless insurance coverage.",
            bg: "#fce7f6",
            image: iphone3,
            active: like,
                ...
                <div className='flex items-center justify-center lg:w-1/2 w-full flex-col'>
                    {textData.map((text, index) => (
                        <div key={index} className=' w-full flex items-start justify-start '>
                            <div className="cursor-pointer flex flex-col items-start mt-2 mb-5 justify-start" onClick={() => handleTextClick(index)}>
                                <div className=' flex items-center justify-center w-full '>
                                    <div className=' flex items-center justify-center w-[10%]'>
                                        {
                                            selectedText && selectedText === index ? (
                                                <img src={textData[index].active} alt={textData[index].title} className='w-16' />) : (
                                                <img src={textData[index].inActive} alt={text.title} className='w-12' />
                                            )
                                        }
                                    </div>
