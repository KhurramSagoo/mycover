import collage from "./assets/monthly-comprehensive-collage.png";

const MonthlyComprehensiveCollage = () => {
  return (
    <div
      className=" p-10 mt-5
    ...
    >
      ...
      >
        ...
        <p className=" text-white mb-4 text-[22px] md:text-2xl lg:text-5xl  py-5 font-bold flex items-start">
          Get Monthly Comprehensive Insurance created to suit your budget
        </p>
...
export default MonthlyComprehensiveCollage;
