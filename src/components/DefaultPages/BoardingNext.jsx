    ...
    <div className="p-5 h-screen">
      ...
      <div>
        ...
        <div className=" flex items-center justify-center sm:px-16 px-5 w-full flex-col py-5">
          ...
          <p className=" text-gray-500 text-sm  pt-5 font-semibold">
            Explore the world without worry. Our travel Insurance plan gives you
            360° coverage when you travel outside the country.
          </p>
        </div>
      </div>
      ...
      <div className="  flex items-center justify-center">
        <div className="border rounded-lg bg-[#f6fef9] p-5  max-w-[600px] w-full ">
          ...
          <div className=" flex items-start justify-start flex-col">
            ...
            <span className=" cursor-pointer text-primary py-5 ml-5">
              {" "}
              Learn More
            </span>
          </div>
          <div className=" text-xs font-semibold text-gray-600 border border-[#f79009] bg-[#fffaeb] p-3 rounded-md">
            Important Notice: This plan is available only for individuals below
            the age of 70.
          </div>
        </div>
      </div>
      <div className=" flex items-center justify-center py-10 w-full">
        <button
          className=" w-full py-5 bg-primary text-white rounded-lg max-w-[600px]"
