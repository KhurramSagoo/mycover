...
const BasicProtection = ({ item }) => {
  ...
  return (
    <div className=" flex items-center justify-center lg:flex-row flex-col  lg:px-16 lg:py-20 py-10 md:my-16 my-0 md:px-5 sm:px-2 px-2 bg-[#f8fcfb] h-full">
      {/* left portion start */}
      <div
      ...
      <div className="lg:w-2/5  h-[400px] my-5 w-full px-5 sm:px-10">
        ...
        <div className=" flex items-center justify-center text-sm text-primary font-bold py-5">
