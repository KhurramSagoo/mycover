...
export const heroData = [
  {
    ...
    detail:
      "Spend less time worrying about the health of your staff with health coverage as little as ₦2,000 per staff.",
    span: "",
    btn: "Get Covered",
  },
];
...
export const basicData = [
  {
    top: "What’s more?",
    head: "Protect your health at no extra cost",
    detail:
      "Illnesses show up without warning, that’s why we’ve made getting healthcare so affordable to fit your budget.",
    span: "",
    btn: "Get Covered",
  },
];
...
const middlePlans = [
  {
    title: "Easy access to care",
    detail:
      "With access to over 1,000 hospitals, your team is always close to any health centre in our network.",
    image: <CheckCircleIcon />,
    bg: "#fce7f6",
  },
  {
    ...
    detail:
      "Our onboarding process is fast and automated. No paper, no long forms, get cover for all your hundreds and thousands of staff in minutes.",
  ...
  },
  {
    ...
    detail:
      "Flexicare mini is flexible and affordable to help you make strategic decisions on budgeting",
