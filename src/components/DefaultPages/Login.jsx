  ...
  return (
    <div className=" w-full flex items-start justify-start md:h-screen h-auto">
      ...
      <div className="hidden md:flex items-start justify-start bg-loginBg md:w-1/3  h-screen relative">
        <div className=" lg:px-[60px] lg:pt-[60px] md:px-8  ">
          <div className="  py-6 mb-12">
            <img loading="lazy" src={logo} alt="" className=" w-[160px]" />
          </div>

          <div className=" w-full flex items-start justify-start md:pr-8 pr-0  text-white">
            <p className=" lg:text-3xl md:text-2xl font-medium break-words pl-0 ">
              Get ready to enjoy insurance that truly covers you
            </p>
          </div>
      ...
      <div className=" md:w-2/3 w-full p-2 md:px-5">
        <div
          className=" bg-[#e6f4f2] flex items-center justify-center w-28 rounded-xl px-2 py-2 ml-5 h32 text-gray-600 cursor-pointer "
          onClick={() => navigate(-1)}
        >
          <ArrowLeft />{" "}
          <p className=" text-sm text-gray-600 font-medium">Go Back</p>
        </div>

        {/* heading */}
        <div className="md:mt-16 md:px-4 md:py-8 px-2 py-6">
          <div className=" w-full flex items-center justify-center flex-col">
            <p className=" text-secondary text-4xl font-bold text-center  break-words">
              Hey, Welcome Back 😊{" "}
            </p>
            <p className=" text-sm py-4 text-gray-500">
              Seeing you always delight us. Please log in
            </p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className=" flex items-start justify-center flex-col  min-w-[300px] sm:w-full py-5">
              ...
              <input
                ...
                className=" border outline-primary rounded-md py-2 w-full my-2 px-2 "
                {...register("email", {
            ...
            <div className=" flex items-start justify-center flex-col  min-w-[300px] sm:w-full py-5">
              ...
              <div className=" w-full my-5">
                <button
                  className=" bg-primary w-full py-2 rounded-md text-white opacity-90"
                  // disabled={!isValid}
                >
                  Login
                </button>
