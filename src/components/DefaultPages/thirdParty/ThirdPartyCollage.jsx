import collage from "./assets/thirdparty-collage.png";
const ThirdPartyCollage = () => {
  return (
    <div
      className=" p-10 mt-5
    ...
    >
      ...
      >
        ...
        <p className=" text-white mb-4 text-[22px] md:text-2xl lg:text-5xl  py-5 font-bold flex items-start">
          Get 3rd Party Auto Insurance that suit your team needs.
        </p>
...
export default ThirdPartyCollage;
